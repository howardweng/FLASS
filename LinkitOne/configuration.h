...
#define WIFI_SSID "Crystalant 2.4G"         // REPLACE: your network SSID (name)
#define WIFI_PASS "1111111111"   // REPLACE: your network password (use for WPA, or use as key for WEP)
...
//Step 3:MQTT info
//MQTT-IoT
#define MQTT_PROXY_IP "gpssensor.ddns.net"  // Current LASD server , dont change! gpssensor.ddns.net
#define DEVICE_TYPE  "LinkItONE"            // since there is only one device LASS supported now,dont change!
#define DEVICE_ID "Howard222"                 // REPLACE: The device ID you like, please start from LASD. Without this prefix, maybe it will be filter out.
#define MQTT_TOPIC_PREFIX "LASS/Test/howard"       // CAN REPLACE if you like //Dont Replace IF YOU ARE FIELD-TRY USER
...
const char gps_lat[]= "24.94925";  // device's gps latitude
const char gps_lon[]= "121.37639";   // device's gps longitude
